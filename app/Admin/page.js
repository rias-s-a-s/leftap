...
import AddPost from '../../Components/Admin/Add/page'
...
function Admin() {
    ...
    return (
        <>
            {/* <!-- component --> */}
            <AdminMenu set={setOpen} />
            <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
                <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
                    <div class="px-6 flex items-center justify-between space-x-4 2xl:container">
                        <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">{open == "Add" && "Crear Post" || open == "View" && "Post Creados" || "Dashboard"}</h5>
