...
const ModalBlog = ({ Modal, setModal }) => {
    ...
    try {
      ...
      if (Object.keys(Modal?.InfoEditar).length > 0) {
        if (Object.keys(InputValues).length > 0) {
          const UpdateRef = doc(db, "Blog", `${Modal?.InfoEditar?.id}`);
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Title className="uppercase">Agregar una nuevo blog</Title>
          <Divider />
          <form onSubmit={handlerSubmit}>
            <div className=" grid sm:grid-cols-1  gap-2 ">
              <div>
                ...
                >
                  Titulo del blog <span className="text-red-500"> (*)</span>
                </label>
                <input
                  name="Titulo"
                  id="Titulo"
              ...
              <div>
                ...
                <QuillNoSSRWrapper
                  ...
                  defaultValue={Modal?.InfoEditar?.Blog}
                />
              </div>
            </div>
